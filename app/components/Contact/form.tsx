...
export default function Form() {
  ...
  return (
    <>
      ...
      <form
        action='https://getform.io/f/aronogmb'
        method='POST'
        onSubmit={handleSubmit}
        ref={formRef}
        className='w-[80%] m-auto mt-24 clientInquiryForm'
      >
        <div className='lg:flex block gap-24 justify-between lg:pb-8 pb-0'>
          ...
          <div className='flex flex-col w-full lg:pb-0 pb-[2.5rem]'>
            <label
              htmlFor='email'
              className={
                (submitButtonClicked && emailInput === "") ||
                (submitButtonClicked && !validEmail)
                  ? "labelError h3 text-left pb-2"
                  : "h3 text-left pb-2"
              }
            >
            ...
            {submitButtonClicked && !validEmail && emailInput != "" && (
              <h4 className='text-right text-red-600'>enter valid email</h4>
            )}
            <input
              required
              id='email'
        ...
        <div className='lg:flex block gap-24 justify-between pb-8'>
          <div className='flex flex-col w-full lg:pb-0 pb-[2.5rem]'>
            <label htmlFor='business_name' className='h3 text-left pb-2'>
        ...
        <div className='lg:flex block flex-col pb-16 lg:w-1/2 w-full'>
          <label
            htmlFor='findUs'
            className='h3 text-left pb-2 lg:float-none float-left'
          >
            how&apos;d you hear about the studio?
          </label>
          <select
            name='findUs'
            id='findUs'
            className='h3 lg:w-auto w-full lg:mt-0 mt-4'
          >
        ...
        <div className='flex'>
          <button
            ...
            className='submitButton h3 hover:!text-offBlack bg-transparent border-[1.5px] border-blancheWhite text-blancheWhite py-[.8rem] px-8 button hover:bg-tarantinoYellow hover:border-tarantinoYellow hover:rounded-[.8rem] mt-8 duration-200 ease-in-out'
          >
            Submit
          </button>
        </div>
