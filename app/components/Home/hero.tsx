    ...
    return (
        <>
            <div className="heroContainer h-screen">
                <h1 className=" capitalize text-[18px] text-tarantinoYellow text-center font-light">AN INDEPENDENT DESIGN  STUDIO FOR AUTHENTIC  BRANDS LIVING IN THE CHAOTIC GOOD.</h1>
